...
// THREAD SAFE
double Utils::ncorr_round(const double &r) {
...
// THREAD SAFE
int Utils::mod_pos(const int &i, const int &n) {
    return (i % n + n) % n;
}

// THREAD SAFE
void Utils::form_boundary(std::vector<std::vector<int>> &vec_boundary, const std::vector<int> &point_init, const class_logical_array &mask, int &direc) {
    // Initialize newpoint
...
// THREAD SAFE
void Utils::cholesky(std::vector<double> &mat, bool &positivedef, const int &size_mat) {
...
// THREAD SAFE
void Utils::forwardsub(std::vector<double> &vec, const std::vector<double> &mat, const int &size_mat) {
...
// THREAD SAFE
void Utils::backwardsub(std::vector<double> &vec, const std::vector<double> &mat, const int &size_mat) {
...
// NOT THREAD SAFE
bool Utils::interp_qbs(double &interp, const double &x_tilda, const double &y_tilda, const class_double_array &plot_interp, const class_logical_array &mask, const int &offset_x, const int &offset_y, const int &border_bcoef) {
...
// THREADSAFE
void Utils::expand_filt(class_double_array &plot_extrap, const class_inverseregion &inverseregion) {
...
// THREAD SAFE
void Utils::form_regions(std::vector<vec_struct_region> &region, bool &removed, const class_logical_array &mask, const int &cutoff, const bool &preservelength) {
